...
from snakes_util import imrotate, plot_snakes, CNN_B, snake_graph, plot_for_figure
...
#model_path = 'models/liverpng568/'  0.76
model_path = 'models/liverpng568_b1_l7/'
do_plot = False
do_train = False
...
L = 160
batch_size = 1
numfilt = [32,64,64,128,128,128,256,256]
im_size = 512
out_size = 256
...
def epoch(n,i,mode):
    ...
    init_u = out_size / 2 + 40 * np.cos(s)-50
    init_v = out_size / 2 + 40 * np.sin(s)+10
